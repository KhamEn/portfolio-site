...
export const Projects = () => {
  return (
    <section>
      <h2 className="text-center text-brand my-fluid-m-lg">I Made</h2>

      <article className="w-full border-2 rounded shadow-3d-md-b md:grid md:grid-cols-3 p-fluid-m-lg md:aspect-video tablet:shadow-3d-lg-bl md:shadow-brand md:shadow-3d-xl-br tablet:shadow-brand shadow-brand border-brand md:gap-fluid-m-lg">
        <div className="flex flex-col justify-between h-full gap-fluid-2xs-s">
          <div>
          ...
          <hr className="w-1/2 mx-auto border-dotted border-shade-shade"></hr>
        ...
        <img
          ...
          className="object-cover h-full col-start-2 col-end-4 border-4 rounded-md border-light-shade mt-fluid-m-lg md:mt-0"
          alt="screenshot"
        />
      </article>
