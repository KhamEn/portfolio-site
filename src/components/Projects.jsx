...
export const Projects = () => {
  return (
    <section>
      ...
      <article className="w-full rounded-lg border border-light-accent p-component shadow-3d-md-b shadow-light-accent tablet:shadow-3d-lg-br tablet:shadow-light-accent md:grid md:aspect-video md:grid-cols-3 md:gap-fluid-m-lg">
        <img
      ...
      <article className="w-full rounded-lg border border-light-accent p-component shadow-3d-md-b shadow-light-accent tablet:shadow-3d-lg-bl tablet:shadow-light-accent md:grid md:aspect-video md:grid-flow-col-dense md:grid-cols-3 md:gap-fluid-m-lg">
        <img
          src={schemeBankDesktopImgURL}
